...
@section('content')
    ...
    <div class="max-w-5xl">
        ...
        <div class="bg-white rounded-[32px] border border-gray-100
            ...
            <form action="{{ route('admin.exhibitions.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <input type="text" name="subtitle" class="w-full rounded-2xl border border-gray-200 px-6 py-4">
                ...
                <div class="grid grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="date" name="start_date" class="w-full rounded-2xl border border-gray-200 px-6 py-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="end_date" class="w-full rounded-2xl border border-gray-200 px-6 py-4">
                    ...
                    <div class="grid grid-cols-2 gap-4 max-h-[400px]
                        ...
                        @foreach ($artworks as $artwork)
                                        ...
                                        <label data-title="{{ strtolower($artwork->title) }}" data-category="{{ $artwork->category_id }}"
                                            ...
                                            <input type="checkbox" name="artworks[]" value="{{ $artwork->id }}" class="w-5 h-5 rounded">

                                            <img src="{{ str_starts_with($artwork->image_url, 'http')
                            ? $artwork->image_url
                            : asset('storage/' . $artwork->image_url) }}"
