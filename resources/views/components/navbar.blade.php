    ...
    <nav class="bg-black/40 backdrop-blur-md text-white">
        ...
        <div class="max-w-7xl mx-auto px-8 py-5 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-10 text-sm uppercase tracking-[0.2em]">
                ...
                <a href="/artworks" class="uppercase tracking-[0.3em] text-sm pb-2 border-b transition duration-300 {{ request()->is('artworks*') ? 'border-white text-white' : 'border-transparent text-white/80 hover:text-white hover:border-white/40' }}">
